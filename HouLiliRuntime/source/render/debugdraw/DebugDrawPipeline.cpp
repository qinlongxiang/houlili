...
namespace HouLili
{
    ...
    void DebugDrawPipeline::setupRenderPass()
    {
        ...
        std::vector<RHIAttachmentDescription> attachments = { color_attachment_description ,depth_attachment_description };
    ...
    void DebugDrawPipeline::setupPipelines()
    {
        ...
        RHIShader* vert_shader_module = m_rhi->createShaderModule(vertShaderCode);
        RHIShader* frag_shader_module = m_rhi->createShaderModule(fragShaderCode);
    ...
    void DebugDrawPipeline::draw(uint32_t current_swapchain_image_index)
    {
    ...
    void DebugDrawPipeline::drawTraingle() {
        ...
        // °ó¶¨ÃüÁî
        //m_rhi->cmdBindPipelinePFN(m_rhi->getCurrentCommandBuffer(), RHI_PIPELINE_BIND_POINT_GRAPHICS, m_render_pipelines.at(0));
    ...
    void DebugDrawPipeline::tick(float delta) {
