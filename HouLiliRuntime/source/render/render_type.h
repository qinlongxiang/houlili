...
#include "source/core/base/hash.h"
...
template<>
struct std::hash<HouLili::MeshSourceDesc>
{
    size_t operator()(const HouLili::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<HouLili::MaterialSourceDesc>
{
    size_t operator()(const HouLili::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
