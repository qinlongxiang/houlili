...
namespace HouLili
{
    std::unordered_map<uint32_t, VkSampler> vulkan_util::m_mipmap_sampler_map;

    uint32_t vulkan_util::findMemoryType(VkPhysicalDevice      physical_device,
    ...
    VkShaderModule vulkan_util::createShaderModule(VkDevice device, const std::vector<unsigned char>& shader_code)
    {
    ...
    void vulkan_util::createBuffer(VkPhysicalDevice      physical_device,
                                  VkDevice              device,
                                  VkDeviceSize          size,
                                  ...
                                  VkDeviceMemory&       buffer_memory)
    {
        ...
        buffer_memory_allocate_info.memoryTypeIndex =
            vulkan_util::findMemoryType(physical_device, buffer_memory_requirements.memoryTypeBits, properties);
    ...
    void vulkan_util::createBufferAndInitialize(VkDevice              device,
    ...
    void vulkan_util::copyBuffer(RHI*         rhi,
                                VkBuffer     srcBuffer,
                                VkBuffer     dstBuffer,
    ...
    void vulkan_util::createImage(VkPhysicalDevice      physical_device,
                                 VkDevice              device,
    ...
    void vulkan_util::createGlobalImage(RHI*               rhi,
                                       VkImage&           image,
                                       ...
                                       uint32_t           miplevels)
    {
        ...
        vulkan_util::createBuffer(static_cast<VulkanRHI*>(rhi)->m_physical_device,
    ...
    void vulkan_util::createCubeMap(RHI*                 rhi,
                                   VkImage&             image,
                                   VkImageView&         image_view,
                                   VmaAllocation&       image_allocation,
                                   uint32_t             texture_image_width,
    ...
    void vulkan_util::generateTextureMipMaps(RHI*     rhi,
                                            VkImage  image,
    ...
    void vulkan_util::transitionImageLayout(RHI*               rhi,
                                           VkImage            image,
    ...
    void vulkan_util::copyBufferToImage(RHI*     rhi,
                                       VkBuffer buffer,
                                       VkImage  image,
                                       uint32_t width,
                                       uint32_t height,
    ...
    void vulkan_util::genMipmappedImage(RHI* rhi, VkImage image, uint32_t width, uint32_t height, uint32_t mip_levels)
    {
        if (rhi == nullptr)
        {
            // LOG_ERROR("rhi is nullptr");
    ...
    VkSampler vulkan_util::getOrCreateMipmapSampler(VkPhysicalDevice physical_device,
                                                   VkDevice         device,
                                                   uint32_t         width,
                                                   uint32_t         height)
    {
    ...
    void vulkan_util::destroyMipmappedSampler(VkDevice device)
    {
    ...
    VkSampler vulkan_util::getOrCreateNearestSampler(VkPhysicalDevice physical_device, VkDevice device)
    {
    ...
    VkSampler vulkan_util::getOrCreateLinearSampler(VkPhysicalDevice physical_device, VkDevice device)
    {
    ...
    void vulkan_util::destroyNearestSampler(VkDevice device)
    {
        vkDestroySampler(device, m_nearest_sampler, nullptr);
        m_nearest_sampler = VK_NULL_HANDLE;
    }

    void vulkan_util::destroyLinearSampler(VkDevice device)
    {
